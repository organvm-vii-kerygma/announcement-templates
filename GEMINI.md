...
Run: `organvm ecosystem show announcement-templates` | `organvm ecosystem validate --organ VII`


## Entity Identity (Ontologia)

**UID:** `ent_repo_01KKKX3RVQCW260YJS5R1RJD7K` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve announcement-templates` | History: `organvm ontologia history ent_repo_01KKKX3RVQCW260YJS5R1RJD7K`
